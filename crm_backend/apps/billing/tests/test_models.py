...
class TestExtraordinaryCharge:
    ...
    def test_extraordinary_str(self, building):
        charge = ExtraordinaryCharge.objects.create(
            building=building, description="Roof renovation", total_amount=Decimal("100000")
        )
...
class TestPayment:
    ...
    def test_payment_auto_receipt_number(self, apartment):
        ...
        p = Payment.objects.create(
            apartment=apartment, charge_type="aidat", amount=100, payment_method=Payment.PaymentMethod.CASH
        )
    ...
    def test_payment_receipt_number_unique(self, apartment):
        ...
        p2 = Payment.objects.create(
            apartment=apartment, charge_type="aidat", amount=200, payment_method=Payment.PaymentMethod.CASH
        )

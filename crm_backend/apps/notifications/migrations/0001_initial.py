        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("aidat_reminder", "Aidat Hatırlatma"),
                            ("aidat_overdue", "Aidat Gecikme"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "external_id",
                    models.CharField(
                        blank=True, help_text="External message ID from provider", max_length=100, null=True
                    ),
                ),
                ...
                (
                    "recipient",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="residents.resident"
                    ),
                ),
                (
                    "template",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["recipient", "created_at"], name="notificatio_recipie_3db547_idx"),
                ],
            },
        ),
    ]
